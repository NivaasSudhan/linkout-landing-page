        ...
        {/* <div className="bg-[#010101] pb-32">
          <div className="relative layout">
            ...
            <h2 className="w-3/4 mt-4 text-3xl font-semibold text-white md:text-5xl">
              <span className="grad">Linkout</span> offers an easy and scalable way to write your
              backend code.
            </h2>
            <FeaturesDemo />
          </div>
    ...
    <div className="md:pb-24 pb-12 bg-[#010101]">
      ...
      >
        <div className="px-4 max-w-6xl mx-auto relative md:pt-60 pt-24 pb-8 z-10">
          ...
          {/* <div className="mt-9">
            <LinkoutStudioBeta customText="Read more about Linkout Studio" />
          </div> */}
          <img
          ...
          {/* <div className="max-w-xl mx-auto px-4">
            <a
              ...
              href="/studio"
            >
              Read more about Linkout Studio
            </a>
          </div> */}
        </div>
      </div>
...
//           Linkout <span className="grad">Studio</span>
//         </h2>
//         <p className="w-3/4 mt-4 text-lg text-white text-opacity-50 md:text-xl">
//           Linkout aims to provide the best developer experience ever by simplifying the process of
...
//           Linkout can generate a fully typed client code in any language in matter of seconds. Log
...
//         </h3>
//         <p className="w-3/4 mt-2 text-lg text-white text-opacity-50 md:text-lg">
//           Linkout can generate a clear and concise API reference in a matter of seconds. Log with
      ...
      >
        <div className="relative z-20 py-20 md:py-48 layout">
          ...
          <div
            ...
            className="max-w-md p-0.5 relative mx-auto mt-24 bg-left-bottom hover:bg-right-bottom rounded-md cursor-pointer group transition-all hover:positio"
            style={{
              backgroundSize: "300% 300%",
              transitionDuration: "2000ms",
            }}
...
const FeaturesDemo = () => {
  ...
  const codeImportsString = `import { initLinkout, handler } from 'bridge';\nimport z from 'zod'`;
  const codeImportsWithApplyAndErrorString = `import { initLinkout, handler, apply, httpError } from 'bridge';\nimport z from 'zod'`;

  const initLinkoutAndServerString = `const bridge = initLinkout({ routes: { getMe } });\n\nbridge.HTTPServer().listen(8080, () => {\n    console.log("Listening on port 8080"); \n});`;
  ...
  const authMiddlewareBeginString = `const authMid = handler({
   headers: z.object({ token: z.string() }),o
   resolve: (data) => {`;
  ...
  const features = [
    ...
    },
    {
      ...
      text: "Linkout supports query, body and headers validation using zod, yup or superstruct.",
      icon: "",
    },
    {
  ...
  const fullCode = `import { initLinkout, handler, apply, httpError } from 'bridge';
import z from 'zod'
...
const bridge = initLinkout({ routes: { getMe } });
  ...
  return (
    <div>
      <div className="relative grid mt-16 md:grid-cols-12">
        ...
        <div className="bg-[#0D0D11] overflow-x-auto bg-opacity-75 border md:col-span-7 border-[#14181D] rounded-md">
          ...
          >
            ...
            />
            <CustomCode
              codeString={initLinkoutAndServerString}
              display={true}
              marginTop={16}
              maxHeight={500}
            />
      ...
      <div className="mt-24 rounded-md overflow-hidden">
        <h2 className="text-center text-white text-3xl mb-2">
          Try it yourself!
        </h2>
        <p className="text-neutral-300 text-center text-lg mt-2 mb-6">
          Try out Linkout without leaving your browser!
        </p>
        <div className="rounded-md overflow-hidden">
          <iframe
            src="https://stackblitz.com/edit/express-simple-nnaqkv?ctl=1&embed=1&file=index.ts&theme=dark&view=editor"
...
const FeatureElement = ({
  ...
  return (
    <div className="flex items-center" ref={thisElement}>
      <div
        onClick={() => {
          track("Linkout features element clicked", {
            title,
          });
          setSelected(index);
